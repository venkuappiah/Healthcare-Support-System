    ...
    <body onload = "updateCity(document.getElementById('state').selectedIndex)">
        <center>
            ...
            <div class = "content">
                ...
                <h2>Please fill in your details. All fields are required.</h2>
                ...
                <form class = "registration_form" name = "frmRegistration" action = "<?php echo $_SERVER['PHP_SELF']; ?>" method = "post">
                    <div class = "input">
                        ...
                        <?php if(isset($status['docIdF'])) echo "<p class = 'failure'>Invalid selection.Please select your doctor.</p>";?>
                        <b class = "caption">Doctor</b>
                        <div class="input_element">
                            <select name="selDoctor">
                                <option style = "color:#999999;" value="0+ ">Select your doctor</option>
                                    <?php
                                        for ($i = 0; $i < count($arDoctors); ++$i)
                                            {
                                                $row = $arDoctors[$i];
                                                if(isset($_POST['selDoctor']))
                                                {
                                                    if($docId == $row['personId'])
                                                    {
